...
def plotDifferentClassifiers(results_analyzer, dirData, dirModelsBase, dirResultsBase):
    ...
    # dict_opt_lr_l2 = {'penalty': 'l2', 'C': 0.1};
    ...
    dict_opt_lr_l1 = {'penalty': 'l1', 'C': 0.1};
    ...
    analyzer = [analyzer_rf, analyzer_lr_l1];
    names = ['rf', 'logistic regression (l1)']
    ...
    results_analyzer.plotROCcurveMulitpleConfigs(analyzer, names, f_plot=filename_plot, titlePlot='', )
...
def plotDiseasePerformances(results_analyzer, dirData, dirModelsBase, dirResultsBase):
    ...
    filename_plot = dirPlotsBase + 'diseases_classification_performance.png'
