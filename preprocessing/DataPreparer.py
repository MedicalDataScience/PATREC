...
class DataPreparer:
    ...
    def _removeAllFeaturesButDiag(self):
        ...
        strFilenameInSubGroup = dataset + '_' + sub + '_' + grouping;
        filename_data_subgroup = os.path.join(dir_data, data_prefix + '_' + strFilenameInSubGroup + '.csv');
        print(filename_data_subgroup)
    ...
    def fuseSubgroups(self):
        ...
        filename_data_out = os.path.join(dir_data, data_prefix + '_' + filename_out_str + '.csv');
        filename_data_in = os.path.join(dir_data, data_prefix + '_' + filename_in_str + '.csv');
