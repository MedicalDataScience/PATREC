...
class FeatureSetCreator:
    ...
    def createFeatureSet(self):
        ...
        if newfeatures is None and featurereduction is None:
            filename_data_in = dir_data + 'data_' + data_prefix + '_' + dataset + '_' + name_dem_features + '_' + self.filename_options_in + '.csv';
            filename_data_out = dir_data + 'data_' + data_prefix + '_' + dataset + '_' + name_dem_features + '_standard.csv';
